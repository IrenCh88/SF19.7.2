...
def test_add_new_pet_with_valid_data(name='Alisa', animal_type='лиса',
                                     age='4', pet_photo='images/fox.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Заза", "жмот", "6", "images/fox.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Дюня', animal_type='лисичкин', age=1):
    ...
    # тест 1
def test_add_new_pet_simple_with_valid_data(name='Котя', animal_type='норвежская',
                                            age='18'):
...
def test_add_photo_of_pet(pet_photo='images/cat.jpg'):
    ...
    # Добавляем питомца без фото
    _, _ = pf.add_new_pet_simple(auth_key, 'КОТ', 'инди', '1')
    ...
    # тест 3
def test_add_new_pet_with_invalid_pet_photo(name='Лик', animal_type='овчарка',
                                            age='',
                                            pet_photo=''):
    ...
    # тест 4
def test_get_api_key_for_invalid_user(email=valid_email, password='1234550'):
    ...
    # тест 5
def test_add_new_pet_with_negative_age(name='Зузя', animal_type='рыжик',
    ...
    # тест 6
def test_add_new_pet_with_invalid_age(name='Даша', animal_type='рыжехвостая',
                                       age='1000', pet_photo='images/fox.jpg'):
...
def test_add_new_pet_with_long_name(name='Аваллоннннннннннннннннннннннннннннннннннннннннннн'
                                       ...
                                       age='10', pet_photo='images/nudle.jpg'):
    ...
    # тест 8
def test_update_pet_info_with_negative_age(name='Жмурик', animal_type='длиный', age=-5):
    ...
    # тест 9
    def test_update_pet_info_with_long_name(name='Nudls', animal_type='лапша', age=1):
